...
%\begin{figure}[ht!]
%\caption{Processo de Testes Exploratórios dentro do %Contexto do Desenvolvimento}
%\centering
%\includegraphics[width=\textwidth]{processoPreview.png}
%\end{figure}
